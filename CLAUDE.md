...
# release: bump VERSION + `go run ./cmd/slk generate-skill` + `./scripts/sync-version.sh` in a PR; merge to main → GHA auto-tags v<VERSION> & releases
